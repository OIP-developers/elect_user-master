...
import { DeleteCard, SavedCards } from '../../../redux/actions/ride.action'
import { DefaultCard, WalletDetail, WalletUrl } from '../../../redux/actions/user.action'
    ...
    <SafeAreaView>
      ...
      >
        ...
        >
          ...
          >
            {Country == "UKRAINE" ? "₴" : "$ "}{myWalllet?.balance?.balance ? myWalllet?.balance?.balance / 100 : 0.00}
          </Text>
          <Text
            style={{
      ...
      </View>
      {
        myWalllet?.account?.payouts_enabled == false ?
          ...
          >
            ...
            >
              {Country == "UKRAINE" ? "Підключити гаманець" : "Connect Wallet"}
            </Text>
      ...
      {Loading == false ?
          ...
          return (
            ...
            >
              ...
              >
                ...
                >{Country == "UKRAINE" ? "Картка за замовчуванням" : "Default Card"}</Text> :
                  <TouchableOpacity
                  ...
                  >
                    ...
                    >{Country == "UKRAINE" ? "Зробити цю картку типовою" : "Tap here to Make this Card Default"}</Text>
                  </TouchableOpacity>
                }
              </View>
              <TouchableOpacity
        ...
        >
          ...
          >{Country == "UKRAINE" ? "" : "Working on your Request"}</Text>
        </View>
      }
